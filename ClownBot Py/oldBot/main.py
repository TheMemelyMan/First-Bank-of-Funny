...
async def on_message(message):
    ...
    #if(content.find("!clown") != -1 or content.find("!funny") != -1 or content.find("!unfunny") != -1 or content.find("!goon") != -1 or content.find("!spinCycle") != -1):
...
async def bannerQueue(ctx):
    ...
    requestEmbed.set_thumbnail(url="https://derpicdn.net/img/2019/10/13/2167624/large.jpeg")
    ...
    approvedEmbed.set_thumbnail(url="https://derpicdn.net/img/2019/10/13/2167624/large.jpeg")
